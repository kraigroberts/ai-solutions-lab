...
class LocalLLMProvider:
    ...
    async def run_agent(
        ...
        try:
            ...
            tool_descriptions = self.tool_registry.get_tool_descriptions(available_tools)
            ...
            while current_step <= max_steps:
                ...
                if "GOAL ACCOMPLISHED" in content.upper() or "TASK COMPLETE" in content.upper():
                    steps.append({
                        "step": current_step,
                        "tool": "reasoning",
            ...
            return {
                ...
                "tools_used": list(set(step["tool"] for step in steps if step["tool"] != "reasoning"))
            }
    ...
    def _create_agent_system_prompt(self, goal: str, tool_descriptions: Dict[str, str]) -> str:

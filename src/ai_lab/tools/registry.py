...
class Tool:
    ...
    def _validate_function(self) -> None:
        ...
        if len(params) != 1 or params[0] != 'input_data':
            raise ValueError(f"Tool function {self.name} must take exactly one parameter named 'input_data'")
...
class ToolRegistry:
    ...
    def get_tool_descriptions(self, tool_names: Optional[List[str]] = None) -> Dict[str, str]:
    ...
    def _register_default_tools(self) -> None:
        ...
        search_tool = Tool(
            ...
            examples=[
                {"input": "machine learning basics", "output": "Information about machine learning fundamentals"},
                {"input": "Python programming", "output": "Python programming concepts and examples"}
            ]
        )
        ...
        web_tool = Tool(
            ...
            examples=[
                {"input": "https://example.com", "output": "Information about the webpage"},

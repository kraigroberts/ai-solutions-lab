...
def mock_llm_router():
    ...
    with patch("ai_lab.api.LLMRouter") as mock_router_class:
        ...
        mock_router.run_agent = AsyncMock(
            return_value={
                "result": "Test result",
...
class TestChatEndpoint:
    ...
    def test_chat_endpoint_success(self, client, mock_llm_router):
        ...
        chat_data = {"messages": [{"role": "user", "content": "Hello, how are you?"}]}
    ...
    def test_chat_endpoint_invalid_messages(self, client):
        ...
        chat_data = {"messages": []}  # Empty messages
...
class TestRAGEndpoint:
    ...
    def test_rag_answer_success(self, client, mock_rag_answerer):
        ...
        rag_data = {"query": "What is machine learning?"}
    ...
    def test_rag_answer_with_top_k(self, client, mock_rag_answerer):
        ...
        rag_data = {"query": "What is machine learning?", "top_k": 10}
    ...
    def test_rag_answer_with_index_path(self, client, mock_rag_answerer):
        ...
        rag_data = {"query": "What is machine learning?", "index_path": "/custom/index"}
...
class TestAgentEndpoint:
    ...
    def test_agent_run_success(self, client, mock_llm_router):
        ...
        agent_data = {"goal": "Calculate 15 * 23 and search for Python info"}
    ...
    def test_agent_run_with_tools(self, client, mock_llm_router):
        ...
        agent_data = {"goal": "Test goal", "tools": ["search", "math"]}
    ...
    def test_agent_run_with_max_steps(self, client, mock_llm_router):
        ...
        agent_data = {"goal": "Test goal", "max_steps": 5}
...
class TestErrorHandling:
    ...
    def test_validation_errors(self, client):
        ...
        invalid_data = {"messages": "not a list"}  # Should be a list
